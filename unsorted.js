var roomList = {
  ...
  "Blk A, 29 Heng Mui Keng Terrace": {
    "rooms": [
  ...
  "Block B, BTC": {
    "rooms": [
      ...
      "Faculty of Law (Block B)",
      "Institute of South Asian Studies (ISAS)",
      "Middle East Institute (MEI)",
      "The Summit",
      "DBS / POSBank ATMs (Bukit Timah Campus)",
      "AXS (Bukit Timah Campus)",
      "Coop - Bukit Timah Campus (Block B)"
    ]
  },
  "C J Koh Law Library": {
    "rooms": [
  ...
  "Eu Tong Sen, BTC": {
    "rooms": [
      "Faculty of Law (Eu Tong Sen)"
    ]
  },
  "Federal, BTC": {
    "rooms": [
      "Faculty of Law (Federal)"
    ]
  },
  "House 3": {
    "rooms": [
  ...
  "Li Ka Shing, BTC": {
    "rooms": [
      "Lee Kuan Yew School of Public Policy (Li Ka Shing)",
      "Reedz Cafe (Li Ka Shing Building)",
      "Sapore Italiano (Bukit Timah)"
    ]
  },
  "Lovers' Park": {
    "rooms": [
  ...
  "Manasseh Meyer, BTC": {
    "rooms": [
      "Lee Kuan Yew School of Public Policy (Manasseh Meyer)"
    ]
  },
  "Munchie Monkey": {
    "rooms": [
  ...
  "Oei Tiong Ham, BTC": {
    "rooms": [
      "Lee Kuan Yew School of Public Policy (Oei Tiong Ham)"
    ]
  },
  "Old Chang Kee": {
    "rooms": [
  ...
  "Security Post, BTC": {
    "rooms": [
      "Security Post (Bukit Timah Campus)"
    ]
  },
	...
	for( fullmapvert in fullMap){
      for( roomlistvert in roomList){
         if (fullmapvert == roomlistvert) {
            fullMap[fullmapvert].rooms = roomList[roomlistvert].rooms;
